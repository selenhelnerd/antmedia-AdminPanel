...
export class V2BroadcastsİdTokenService {
    /**
     * Generates random one-time token for specified stream
     * @returns any OK
     * @throws ApiError
     */
    public static getV2BroadcastsToken({
        id,
        accept,
        expireDate,
        type,
        ...
        expireDate?: string,
        /**
         * (Required) Type of the token. It may be play or publish
         */
        type?: string,
        /**
